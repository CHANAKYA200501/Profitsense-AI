...
## ET AI Hackathon 2026 · Problem #6: AI for the Indian Investor
...
---
*Built for ET AI Hackathon 2026 · Team [Your Name]*
```
```

---

## IMPLEMENTATION CHECKLIST (72 HOURS)

### ✅ HOUR 0–6: Environment Setup
- [ ] Clone repo, configure .env
- [ ] `docker compose up postgres redis qdrant mlflow`
- [ ] Run DB migrations: `alembic upgrade head`
- [ ] Test NSE API session: verify bulk deals endpoint works
- [ ] Test yfinance: download RELIANCE.NS 5Y data
- [ ] Verify Anthropic API key works

### ✅ HOUR 6–24: ML Training
- [ ] Run feature engineering on 50 stocks first (test)
- [ ] Train XGBoost on 50 stocks (1-2 hours) — validate it works
- [ ] Expand to 200 stocks overnight
- [ ] Check MLflow: experiments visible at localhost:5000
- [ ] Save model artifacts, verify pickle loading

### ✅ HOUR 24–36: Backend Agents
- [ ] Signal Finder: insider cluster + 52W breakout + bulk deal working
- [ ] Chart Pattern Agent: 5+ patterns detected via pandas-ta
- [ ] Narrator Agent: Claude API integration, format output correctly
- [ ] Portfolio Context Agent: basic hold/accumulate/exit logic
- [ ] Orchestrator: tie all 4 agents together in sequence

### ✅ HOUR 36–48: FastAPI + Database
- [ ] All 6 API endpoints working (/signals, /analyze, /backtest, /mf, /portfolio, /ws)
- [ ] WebSocket live feed working
- [ ] Redis caching working (signals TTL 5 min)
- [ ] Celery tasks: signal scan job running on schedule
- [ ] Back-test data seeded (at minimum 1 year, 100 stocks)

### ✅ HOUR 48–62: Frontend Dashboard
- [ ] React app running at localhost:5173
- [ ] Signal cards with expandable detail (What/Why/History/Action)
- [ ] WebSocket connection to live feed
- [ ] Back-test stats chart (recharts)
- [ ] Portfolio panel with P&L
- [ ] CAMS upload UI

### ✅ HOUR 62–68: Polish + Demo Prep
- [ ] Pre-compute 5 impressive historical demo signals
- [ ] Ensure back-test win rates are real (calculated from DB)
- [ ] Mobile responsive layout
- [ ] Error states and loading spinners

### ✅ HOUR 68–72: Submission
- [ ] Record 3-minute demo video (show one full signal lifecycle)
- [ ] Write architecture doc (1-2 pages)
- [ ] Finalize impact model (real numbers from back-test DB)
- [ ] Push clean commit history to GitHub
- [ ] Write compelling README.md

---
*ETMIND · ET AI Hackathon 2026 · Problem #6: AI for the Indian Investor*
*Stack: Python · TypeScript · PostgreSQL · Redis · Qdrant · Docker · PyTorch · XGBoost · Claude API*
```
